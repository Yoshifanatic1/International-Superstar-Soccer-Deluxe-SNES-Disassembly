...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the ISSD_InsertIntegratedPatches and ISSD_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro ISSD_InsertIntegratedPatches()
...
macro ISSD_ApplyPatchesPostAssembly()
...
macro ISSD_HandleDefaultPatches()
