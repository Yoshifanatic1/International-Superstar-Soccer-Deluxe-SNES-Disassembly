...
set asarVer=asar
set GAMDID="ISSD"
set FolderName="International_Superstar_Soccer_Deluxe"
set ROMVer=
set ROMExt=.sfc
set HackCheck=""
set HackName=""
...
echo - International Superstar Soccer Deluxe (USA)
...
echo Valid options: "ISSD_U" "ISSD_E" "ISSD_J"
...
if "%Input1%" equ "ISSD_U" goto :USA
if "%Input1%" equ "ISSD_E" goto :PAL
if "%Input1%" equ "ISSD_J" goto :Japan
...
:USA
set ROMVer=(USA)
set ROMNAME=International Superstar Soccer Deluxe
goto :Assemble
...
:Japan
set ROMVer=(Japan)
set ROMNAME=Jikkyou World Soccer 2- Fighting Eleven
